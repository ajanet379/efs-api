...
class Stock(models.Model):
    customer = models.ForeignKey(Customer, on_delete=models.PROTECT, related_name='stocks')
    ...
    def current_stock_price(self):
        ...
        api_key = '&interval=1min&apikey=W7VJ27KZL2S18NDC'
...
class Fund(models.Model):
    customer = models.ForeignKey(Customer, on_delete=models.PROTECT, related_name='Fund')
